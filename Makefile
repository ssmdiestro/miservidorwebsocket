#############################################################################
# Makefile for building: miservidorwebsocket
# Generated by qmake (3.1) (Qt 5.9.7)
# Project:  miservidorwebsocket.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile miservidorwebsocket.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../../../websocket/include -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtWidgets -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtSql -isystem /usr/include/qt5/QtCore -I. -isystem /usr/include/libdrm -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = miservidorwebsocket1.0.0
DISTDIR = /home/usuario/Escritorio/webskt/miservidorwebsocket/.tmp/miservidorwebsocket1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -pthread -lz -L/home/usuario/Escritorio/webskt/miservidorwebsocket/../../../websocket/lib/ -lixwebsocket -lQt5Widgets -L/usr/lib64 -lQt5Gui -lQt5Sql -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		usuarios.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		usuarios.o \
		moc_mainwindow.o
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		miservidorwebsocket.pro mainwindow.h \
		usuarios.h \
		json.hpp main.cpp \
		mainwindow.cpp \
		usuarios.cpp
QMAKE_TARGET  = miservidorwebsocket
DESTDIR       = 
...
$(TARGET): /home/usuario/Escritorio/webskt/miservidorwebsocket/../../../websocket/lib/libixwebsocket.a ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: miservidorwebsocket.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/yacc.prf \
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		miservidorwebsocket.pro \
		/usr/lib64/libQt5Widgets.prl \
		/usr/lib64/libQt5Gui.prl \
		/usr/lib64/libQt5Sql.prl \
		/usr/lib64/libQt5Core.prl
	$(QMAKE) -o Makefile miservidorwebsocket.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h usuarios.h json.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp usuarios.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/home/usuario/Escritorio/webskt/miservidorwebsocket -I/home/usuario/websocket/include -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtSql -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-suse-linux -I/usr/include/c++/7/backward -I/usr/lib64/gcc/x86_64-suse-linux/7/include -I/usr/local/include -I/usr/lib64/gcc/x86_64-suse-linux/7/include-fixed -I/usr/x86_64-suse-linux/include -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
main.o: main.cpp ../../../websocket/include/ixwebsocket/IXWebSocketServer.h \
		../../../websocket/include/ixwebsocket/IXSocketServer.h \
		../../../websocket/include/ixwebsocket/IXConnectionState.h \
		../../../websocket/include/ixwebsocket/IXSocketTLSOptions.h \
		../../../websocket/include/ixwebsocket/IXWebSocket.h \
		../../../websocket/include/ixwebsocket/IXProgressCallback.h \
		../../../websocket/include/ixwebsocket/IXWebSocketCloseConstants.h \
		../../../websocket/include/ixwebsocket/IXWebSocketErrorInfo.h \
		../../../websocket/include/ixwebsocket/IXWebSocketHttpHeaders.h \
		../../../websocket/include/ixwebsocket/IXCancellationRequest.h \
		../../../websocket/include/ixwebsocket/IXWebSocketMessage.h \
		../../../websocket/include/ixwebsocket/IXWebSocketCloseInfo.h \
		../../../websocket/include/ixwebsocket/IXWebSocketMessageType.h \
		../../../websocket/include/ixwebsocket/IXWebSocketOpenInfo.h \
		../../../websocket/include/ixwebsocket/IXWebSocketPerMessageDeflateOptions.h \
		../../../websocket/include/ixwebsocket/IXWebSocketSendInfo.h \
		../../../websocket/include/ixwebsocket/IXWebSocketTransport.h \
		../../../websocket/include/ixwebsocket/IXWebSocketHandshake.h \
		../../../websocket/include/ixwebsocket/IXSocket.h \
		../../../websocket/include/ixwebsocket/IXWebSocketInitResult.h \
		../../../websocket/include/ixwebsocket/IXWebSocketPerMessageDeflate.h \
		json.hpp \
		usuarios.h
...
usuarios.o: usuarios.cpp usuarios.h \
		json.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o usuarios.o usuarios.cpp
